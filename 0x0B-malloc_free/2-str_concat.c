...
/**
 * _strlen - return length of a strin
 *
 * @s: char type
...
/**
 * *str_concat - function to allocate space for sting concatnatio
 * @s1: array pointer to destination of string
 * @s2: array pointer to source of string
 * Return: retur pointer to copy of stri
 */
...
char *str_concat(char *s1, char *s2)
{
	...
	if (ptr == NULL)								{
		return (NULL);								}	
	_strncat(ptr, s1, size1);							_strncat(ptr, s2, size2);
	ptr += '\0';									return (ptr);
}
